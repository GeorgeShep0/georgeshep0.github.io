...
/* TICKER */
const accusations = [
    "'HATES COD' BUT IS PRETTY MUCH ALL HE PLAYS",
    "CANNOT STAND CONTROLLER PLAYERS, BUT OWNS A CONTROLLER",
    "HATES SWEATS BUT IS A SWEAT",
    "FREQUENT VISITOR TO WINSTONS",
    "HAS A NECTAR CARD BUT DOESN'T SHOP AT SAINSBURYS",
    "KEYBOARD ENTHUSIAST BUT SMASHES THEM ALL UP",
    "SLATES SHMUCKS, BUT IS A SHMUCK",
    "FAVORITE FILM IS FROZEN",
    "POSSESSES AN ANUS PENIS SLEEVE",
    "DOES NOT CLEAN HIS AUTOBLOW POCKET PUSSY",
    "WEARS A THONG 365 DAYS A YEAR",
    "HASN'T WASHED IN 6 WEEKS BUT RECKONS HE SMELLS NICE",
    "HAS AN ADDICTION TO EJACULATING IN A JAR AND KEEPS SAID JAR ON THE WINDOWSILL",
    "BROKE HIS RIB PEFORMING AUTOFELLATIO AND HAD TO HAVE IT REMOVED"
];
let tickerText = "";
setInterval(() => {
